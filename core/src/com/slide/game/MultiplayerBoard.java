...
public class MultiplayerBoard {
    ...
    /**
     * Constructor for MultiplayerBoard
     *
     * @param x x coordinate
     * @param y y coordinate
     */
    public MultiplayerBoard(int x, int y) {
        //make blocks
    ...
    public void makePiece() {
        ...
        switch (random) {
            case 0:
                ...
                break;
            case 1:
                this.piece = new L_Piece(BOARD_WIDTH / 2, BOARD_HEIGHT);
                break;
            case 2:
                this.piece = new J_Piece(BOARD_WIDTH / 2, BOARD_HEIGHT);
                break;
            default:
                this.piece = new Cude_Piece(BOARD_WIDTH / 2, BOARD_HEIGHT);
                break;
